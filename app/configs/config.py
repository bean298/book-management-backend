...
COMMERCE_SCHEMA = os.getenv(
    "BOOK_MANAGEMENT_COMMERCE_SCHEMA", default="commerce"
)
...
REFRESH_TOKEN_TABLE = os.getenv(
    "BOOK_MANAGEMENT_REFRESH_TOKEN_TABLE", "refresh_tokens"
)
